...
- (void) ycscZp:(void (^)(LYResult*,id))handler;


- (void) getROrderId:(NSString*)orderId payChannel:(NSString *)payChannel selectPay:(NSString *)selectPay
            goodsName:(NSString *)goodsName
               amount:(NSString*)amount
               payExt:(NSString*)payExt;
-(void)hqorder:(void (^)(LYResult*,id,id))handler;
-(void)hqorderResult:(NSString *)orderId payChannel:(NSString *)payChannel completion:(void (^)(LYResult*,id))handler;
