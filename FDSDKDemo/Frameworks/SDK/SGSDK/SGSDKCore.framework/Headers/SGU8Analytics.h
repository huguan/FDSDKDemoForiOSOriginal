...
/// 游戏角色相关事件
typedef NS_ENUM(NSInteger, SG_UserOperateCode)
{
    SG_OP_CREATE_ROLE = 1,
    SG_OP_ENTER_GAME,
    SG_OP_LEVEL_UP,
...
/// 游戏角色相关事件
typedef NS_ENUM(NSInteger, SG_UserExtraDataType)
{
    SG_TYPE_SELECT_SERVER = 1,
    SG_TYPE_CREATE_ROLE,
    SG_TYPE_ENTER_GAME,
    SG_TYPE_LEVEL_UP,
    SG_TYPE_EXIT_GAME
...
/// 设备信息
@interface SGU8DeviceInfo : NSObject
 ...
 * @author dayong
 */
@interface SGU8UserExtraData : NSObject
...
@interface SGU8Analytics : NSObject<ISGU8Analytics>
